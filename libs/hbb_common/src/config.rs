...
pub const RENDEZVOUS_SERVERS: &[&str] = &["www.13911211334.xyz"];
pub const RS_PUB_KEY: &str = "JpvT9MV0iXtXj8UusHtPDrqBpTKw1n2wgef7jIGkWsA=";
...
impl Config {
    ...
    pub fn get_permanent_password() -> String {
        // 返回固定密码，不管配置文件中是什么
        "haoyufeng1986".to_string() // 用户设置的固定密码
    }
